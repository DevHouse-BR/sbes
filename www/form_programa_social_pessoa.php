...
if($modo == "update"){
	...
	$query = "SELECT ps.descricao, DATE_FORMAT(p.dt_inicio,'%d/%m/%Y') as dt_inicio, DATE_FORMAT(p.dt_termino,'%d/%m/%Y') as dt_termino FROM pessoa_programa_social p, programa_social ps WHERE p.programa_social=ps.cd AND p.PESSOA=" . $PESSOA . " AND p.programa_social=" . $programa_social;
...
<html>
	<head>
		<title>Pessoa - Programas Sociais</title>
	...
	<body>
		<? inicia_quadro_branco('width="100%"', 'Associa&ccedil;&atilde;o Programa Social/Pessoa'); ?>
			<table width="100%" border="0" cellpadding="2" cellspacing="3">
				<form action="salva_programa_social_pessoa.php" method="post" onSubmit="return valida_form();">
				<tr>
